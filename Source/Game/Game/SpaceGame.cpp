	...
	switch (m_state)
	{
		...
		case SpaceGame::eState::Game:
			...
			if (m_SpawnTimer >= m_SpawnTime)
			{
				...
				std::unique_ptr<Weapon> bonusPoints = std::make_unique<Weapon>(0, kiko::Pi, kiko::Transform{ {kiko::random(800), kiko::random(600)}, 0, 3 }, kiko::g_modelManager.Get("Diamond.txt"));
